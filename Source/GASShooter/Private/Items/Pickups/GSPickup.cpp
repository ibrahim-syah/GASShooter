...
{
	return bIsActive && TestCharacter && TestCharacter->IsAlive() && IsValidChecked(this) && !TestCharacter->GetAbilitySystemComponent()->HasAnyMatchingGameplayTags(RestrictedPickupTags) && K2_CanBePickedUp(TestCharacter);
}
